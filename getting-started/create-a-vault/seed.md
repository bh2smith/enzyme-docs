...
2. Set up an [**Allowed Deposit Recipients**](https://docs.enzyme.finance/managers/setup/investments) list with only the Vault Manager (or any other wallet address over which you have control) on the it. This is a crucial security precaution because it prevents a 3rd party from depositing during the seeding phase and claiming ownership of the assets before you do.
